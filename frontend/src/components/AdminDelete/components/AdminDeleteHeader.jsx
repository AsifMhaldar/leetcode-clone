...
import { Trash2, RefreshCw, Home } from 'lucide-react';
import { NavLink } from 'react-router';
import { HEADER_BRAND_TITLE, HEADER_BRAND_SUBTITLE, HEADER_REFRESH_TEXT, HEADER_BACK_TEXT } from '../constants';
import './AdminDeleteHeader.scss';

const AdminDeleteHeader = ({ fetchProblems, loading }) => {
  return (
...
export default AdminDeleteHeader;
