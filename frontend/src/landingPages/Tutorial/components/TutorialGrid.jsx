    ...
    <>
      ...
      {filteredTutorials.length === 0 && (
        <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-white rounded-3xl border border-gray-200 mb-8">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-3">No tutorials found</h3>
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            We couldn't find any tutorials matching your criteria. Try adjusting your filters.
          </p>
          <button
            onClick={clearFilters}
