...
export const COURSE_CATEGORIES = [
  { id: 'all', name: 'All Courses', icon: React.createElement(BookOpen, { className: 'w-4 h-4' }), color: 'blue', count: 48 },
  { id: 'web', name: 'Web Development', icon: React.createElement(Globe, { className: 'w-4 h-4' }), color: 'green', count: 15 },
  { id: 'data', name: 'Data Science', icon: React.createElement(BarChart3, { className: 'w-4 h-4' }), color: 'purple', count: 12 },
  { id: 'mobile', name: 'Mobile Development', icon: React.createElement(Smartphone, { className: 'w-4 h-4' }), color: 'orange', count: 8 },
  { id: 'design', name: 'UI/UX Design', icon: React.createElement(Layout, { className: 'w-4 h-4' }), color: 'pink', count: 6 },
  { id: 'backend', name: 'Backend', icon: React.createElement(Terminal, { className: 'w-4 h-4' }), color: 'indigo', count: 7 },
];
...
export const COURSE_STATS = [
  { icon: React.createElement(BookOpen, { className: 'w-6 h-6' }), label: 'Courses', value: '500+', color: 'from-blue-500 to-cyan-500', bg: 'from-blue-50 to-cyan-50' },
  { icon: React.createElement(Users, { className: 'w-6 h-6' }), label: 'Students', value: '1.5M+', color: 'from-green-500 to-emerald-500', bg: 'from-green-50 to-emerald-50' },
  { icon: React.createElement(Clock, { className: 'w-6 h-6' }), label: 'Hours', value: '2,500+', color: 'from-purple-500 to-pink-500', bg: 'from-purple-50 to-pink-50' },
  { icon: React.createElement(Video, { className: 'w-6 h-6' }), label: 'Lectures', value: '12K+', color: 'from-amber-500 to-orange-500', bg: 'from-amber-50 to-orange-50' },
];

export const COURSE_HERO = {
  ...
  heroStats: [
    { label: '1.5M+ students' },
    { label: '4.7 average rating' },
    { label: 'Certificate included' },
  ],
};

export const COURSE_SEARCH_PLACEHOLDER = 'Search courses by title, instructor, or topic...';
export const COURSE_LEVEL_FILTER_LABEL = 'Level';
export const COURSE_PRICE_FILTER_LABEL = 'Price';

export const COURSE_WHY_CHOOSE = [
  { title: 'Expert Instructors', description: 'Learn from industry professionals' },
  { title: 'HD Video Lessons', description: 'High-quality video content' },
  { title: 'Downloadable Resources', description: 'Access content offline' },
  { title: 'Certificate', description: 'Shareable certificate' },
];

export const COURSE_FEATURED_BADGE = 'Featured Course';
export const COURSE_FEATURED_SIDEBAR_TITLE = 'This course includes:';
export const COURSE_FEATURED_CTA = 'Enroll Now';

export const COURSE_GRID_SORT_OPTIONS = ['Most Popular', 'Highest Rated', 'Newest First', 'Price: Low to High', 'Price: High to Low'];
export const COURSE_GRID_EMPTY_TITLE = 'No courses found';
export const COURSE_GRID_EMPTY_DESC = 'We couldn\'t find any courses matching your criteria. Try adjusting your filters.';
export const COURSE_GRID_LOAD_MORE = 'Load More Courses';
export const COURSE_GRID_CLEAR_FILTERS = 'Clear All Filters';

export const COURSE_CTA_TITLE = 'Start Learning Today';
export const COURSE_CTA_DESC = 'Join over 1.5 million students and start your learning journey';
export const COURSE_CTA_BUTTON = 'Get Started For Free';
export const COURSE_CTA_NOTE = 'No credit card required \u2022 30-day money-back guarantee';

export const COURSE_CARD_BESTSELLER_LABEL = 'Bestseller';
export const COURSE_CARD_CERTIFICATE_LABEL = 'Certificate';
export const COURSE_CARD_QUIZ_TAG = 'Quizzes';
export const COURSE_CARD_EXERCISE_TAG = 'Coding exercises';
export const COURSE_CARD_PREVIEW_BTN = 'Preview';
export const COURSE_CARD_LEARN_TITLE = "What you'll learn:";
export const COURSE_CARD_SYLLABUS_TITLE = 'Course syllabus:';
export const COURSE_CARD_SUBTITLES_TITLE = 'Subtitles:';
export const COURSE_CARD_SHOW_MORE = 'Show more details';
export const COURSE_CARD_SHOW_LESS = 'Show less';
